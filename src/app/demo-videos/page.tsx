...
import { Play, Download, Film, ExternalLink } from "lucide-react"
...
const models: Array<{
  ...
  { name: "Random Forest", slug: "random-forest", category: "ml", description: "Ensemble of decision trees.", videoSrc: "/demovideos/random-forest.mp4", poster: "/demovideos/random-forest.jpg" },
  ...
  { name: "LSTM", slug: "lstm", category: "deep-learning", description: "Recurrent network for time series.", videoSrc: "/demovideos/lstm.mp4", poster: "/demovideos/lstm.jpg" },
  { name: "TFT (Temporal Fusion Transformer)", slug: "tft", category: "deep-learning", description: "Multi-horizon forecasting.", videoSrc: "/demovideos/tft.mp4", poster: "/demovideos/tft.jpg" },
