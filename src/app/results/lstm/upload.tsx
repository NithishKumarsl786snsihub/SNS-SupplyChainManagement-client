...
export default function Upload({ onProcessingComplete }: UploadProps) {
  ...
  const getSampleData = () => [
    { Date: "2024-01-01", Demand: 1400, Price: 32, "Inventory Level": 5500, "Seasonal Factor": 1.4, Promotional: 0 },
    { Date: "2024-01-02", Demand: 1350, Price: 32, "Inventory Level": 5350, "Seasonal Factor": 1.4, Promotional: 0 },
    { Date: "2024-01-03", Demand: 1500, Price: 30, "Inventory Level": 5200, "Seasonal Factor": 1.4, Promotional: 1 },
  ]
  ...
  const handleDownload = () => {
    ...
    a.href = url
    a.download = "lstm_sample_dataset.csv"
  ...
  const callDummyUploadEndpoint = async (file: File) => {
    ...
    formData.append("model", "lstm")
    try { 
      await fetch("/api/dummy-upload/lstm", { method: "POST", body: formData }) 
    } catch {}
  }
  ...
  const startProcessing = async (file: File) => {
    ...
    const mockPreviewData = [
      { date: "2024-01-01", actual: 1000, predicted: 1009, confidence_upper: 1080, confidence_lower: 920 },
      { date: "2024-01-02", actual: 1007, predicted: 1016, confidence_upper: 1087, confidence_lower: 927 },
      { date: "2024-01-03", actual: 1014, predicted: 1023, confidence_upper: 1094, confidence_lower: 934 },
    ]
        ...
        <CardContent>
          <div className="flex items-center justify-between p-4 bg-[#F3E9DC]/50 rounded-lg mb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-medium text-gray-900">lstm_sample_dataset.csv</p>
