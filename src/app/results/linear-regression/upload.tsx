...
export default function Upload({ onProcessingComplete }: UploadProps) {
  ...
  const getSampleData = () => [
    { Date: "2024-01-01", Demand: 1000, Price: 20, "Inventory Level": 4000, "Seasonal Factor": 0.9, Promotional: 0 },
    { Date: "2024-01-02", Demand: 950, Price: 20, "Inventory Level": 3850, "Seasonal Factor": 0.9, Promotional: 0 },
    { Date: "2024-01-03", Demand: 1100, Price: 19, "Inventory Level": 3700, "Seasonal Factor": 0.9, Promotional: 1 },
  ]
  ...
  const callDummyUploadEndpoint = async (file: File) => {
    ...
    try { 
      await fetch("/api/dummy-upload/linear-regression", { method: "POST", body: formData }) 
    } catch {}
  }
