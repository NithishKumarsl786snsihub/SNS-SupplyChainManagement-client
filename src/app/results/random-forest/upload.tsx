...
export default function Upload({ onProcessingComplete }: UploadProps) {
  ...
  const getSampleData = () => [
    { Date: "2024-01-01", Demand: 1200, Price: 25, "Inventory Level": 4500, "Seasonal Factor": 1.2, Promotional: 0 },
    { Date: "2024-01-02", Demand: 1150, Price: 25, "Inventory Level": 4350, "Seasonal Factor": 1.2, Promotional: 0 },
    { Date: "2024-01-03", Demand: 1280, Price: 24, "Inventory Level": 4200, "Seasonal Factor": 1.2, Promotional: 1 },
  ]
  ...
  const handleDownload = () => {
    ...
    a.href = url
    a.download = "random_forest_sample_dataset.csv"
  ...
  const callDummyUploadEndpoint = async (file: File) => {
    ...
    formData.append("model", "random-forest")
    try { 
      await fetch("/api/dummy-upload/random-forest", { method: "POST", body: formData }) 
    } catch {}
  }
  ...
  return (
    <>
        ...
        <CardContent>
          <div className="flex items-center justify-between p-4 bg-[#F3E9DC]/50 rounded-lg mb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-medium text-gray-900">random_forest_sample_dataset.csv</p>
      ...
      <div className="mt-8 mb-4">
        ...
        <p className="text-gray-600">Upload your CSV file containing supply chain data. We&apos;ll validate the format and prepare it for forecasting with your selected Random Forest model.</p>
      </div>
