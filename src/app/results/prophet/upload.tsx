...
export default function Upload({ onProcessingComplete }: UploadProps) {
  ...
  const getSampleData = () => [
    { Date: "2024-01-01", Demand: 1300, Price: 30.5, "Inventory Level": 5200, "Seasonal Factor": 1.3, Promotional: 0 },
    { Date: "2024-01-02", Demand: 1220, Price: 30.5, "Inventory Level": 5050, "Seasonal Factor": 1.3, Promotional: 0 },
    { Date: "2024-01-03", Demand: 1380, Price: 29.5, "Inventory Level": 4900, "Seasonal Factor": 1.3, Promotional: 1 },
  ]
  ...
  const callDummyUploadEndpoint = async (file: File) => {
    ...
    formData.append("model", "prophet")
    try { 
      await fetch("/api/dummy-upload/prophet", { method: "POST", body: formData }) 
    } catch {}
  }
  ...
  const startProcessing = async (file: File) => {
    ...
    const mockPreviewData = [
      { date: "2024-01-01", actual: 995, predicted: 1003, confidence_upper: 1063, confidence_lower: 943 },
      { date: "2024-01-02", actual: 1001, predicted: 1009, confidence_upper: 1069, confidence_lower: 949 },
      { date: "2024-01-03", actual: 1007, predicted: 1015, confidence_upper: 1075, confidence_lower: 955 },
    ]
  ...
  return (
    <>
      ...
      <div className="mt-8 mb-4">
        ...
        <p className="text-gray-600">Upload your CSV file containing supply chain data. We&apos;ll validate the format and prepare it for forecasting with your selected Prophet model.</p>
      </div>
