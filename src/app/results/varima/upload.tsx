...
export default function Upload({ onProcessingComplete, modelName }: UploadProps) {
  ...
  const startProcessing = async (file: File) => {
    ...
    try {
      ...
      const endpoint = "http://localhost:8000/api/varima/varima_forecast/"
      console.log("Calling backend:", endpoint, "file:", file.name)
    ...
    <>
      <div className="mt-8 mb-4">
        ...
        <p className="text-gray-600">
          Upload your CSV file. It will be analyzed and sent for forecasting with {modelName}.
        </p>
      </div>
