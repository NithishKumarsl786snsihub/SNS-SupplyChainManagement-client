...
export default function Upload({ onProcessingComplete }: UploadProps) {
  ...
  const getSampleData = () => [
    { Date: "2024-01-01", Demand: 1350, Price: 35, "Inventory Level": 5800, "Seasonal Factor": 1.5, Promotional: 0 },
    { Date: "2024-01-02", Demand: 1300, Price: 35, "Inventory Level": 5650, "Seasonal Factor": 1.5, Promotional: 0 },
    { Date: "2024-01-03", Demand: 1450, Price: 34, "Inventory Level": 5500, "Seasonal Factor": 1.5, Promotional: 1 },
  ]
  ...
  const handleDownload = () => {
    ...
    a.href = url
    a.download = "tft_sample_dataset.csv"
  ...
  const callDummyUploadEndpoint = async (file: File) => {
    ...
    formData.append("model", "tft")
    try { 
      await fetch("/api/dummy-upload/tft", { method: "POST", body: formData }) 
    } catch {}
  }
  ...
  return (
    <>
        ...
        <CardContent>
          <div className="flex items-center justify-between p-4 bg-[#F3E9DC]/50 rounded-lg mb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-medium text-gray-900">tft_sample_dataset.csv</p>
      ...
      <div className="mt-8 mb-4">
        ...
        <p className="text-gray-600">Upload your CSV file containing supply chain data. We&apos;ll validate the format and prepare it for forecasting with your selected TFT model.</p>
      </div>
